...
my_path_to_txt_files = os.path.join(os.getcwd(), 'result_output/ground_truth/*.txt')
...
for txt_file in ground_truth_files_list:
  ...
  path_to_txt_file = os.path.join(os.getcwd(), 'result_output/predicted/' + file_id + ".txt")
...
predicted_files_list = glob.glob(os.path.join(os.getcwd(), 'result_output/predicted/*.txt'))
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    file_id = os.path.basename(os.path.normpath(file_id))
    if class_index == 0:
      if not os.path.exists(os.path.join(os.getcwd(), 'result_output/ground_truth/' + file_id + ".txt")):
